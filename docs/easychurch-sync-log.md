...
| `d045a7e` | 🟢 범용 — 주보 AI 자동채우기에서 기도제목도 사진에서 추출 | 2026-09-26 |
| `4080e3b` | 🟢 범용 — 주보 예배 인도자 입력칸 + AI 추출 (easychurch는 기본값 '임원일 목사' 하드코딩을 해당 교회용으로 바꾸거나 빈칸 처리 필요) | 2026-09-26 |
...
---
_마지막 갱신: 2026-09-26, church-app HEAD `4080e3b` 기준. easychurch-app은 여전히 `ba336c2`
