// 개역개정 기준으로 정리한 짧은 성구 목록. 매일 하나씩 순서대로 노출한다.
// 암기를 바탕으로 옮겨 적은 것이므로, 실제 배포 전 원문과 한 글자씩 대조 확인 필요.
export const DAILY_VERSES = [
  ...
  { ref: "이사야 41:10", text: "두려워하지 말라 내가 너와 함께 함이라 놀라지 말라 나는 네 하나님이 됨이라 내가 너를 굳세게 하리라 참으로 너를 도와주리라" },
  ...
  { ref: "예레미야 29:11", text: "여호와의 말씀이니라 너희를 향한 나의 생각을 내가 아나니 재앙이 아니요 평안이요 너희에게 미래와 희망을 주는 것이니라" },
  ...
  { ref: "마가복음 11:24", text: "그러므로 내가 너희에게 말하노니 무엇이든지 기도하고 구하는 것은 받은 줄로 믿으라 그리하면 너희에게 그대로 되리라" },
  ...
  { ref: "빌립보서 4:6-7", text: "아무 것도 염려하지 말고 다만 모든 일에 기도와 간구로 너희 구할 것을 감사함으로 하나님께 아뢰라 그리하면 하나님의 평강이 너희 마음과 생각을 지키시리라" },
  ...
  { ref: "야고보서 1:2-3", text: "내 형제들아 너희가 여러 가지 시험을 만나거든 온전히 기쁘게 여기라 이는 너희 믿음의 시련이 인내를 만들어 내는 줄 너희가 앎이라" },
