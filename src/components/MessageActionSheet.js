...
export default function MessageActionSheet({
  ...
  return (
    ...
    >
      ...
      >
        <div className="flex items-center justify-center gap-1 border-b border-black/10 pb-3 dark:border-white/10">
          {REACTIONS.map((r) => {
            ...
            return (
              <button
                ...
                title={r.label}
                className={`flex flex-1 flex-col items-center gap-0.5 rounded-lg py-2 text-xl transition-colors ${
