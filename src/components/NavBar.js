...
function NavLink({ href, className, children }) {
  ...
  return (
    <Link
      ...
      className={`-mx-2 -my-1 rounded-full border px-2 py-1 transition-colors duration-300 ${
        pressed
  ...
  return (
    <header className="sticky top-0 z-10 border-b border-black/5 bg-background/80 backdrop-blur-md dark:border-white/10">
      <div className="mx-auto max-w-5xl px-4 py-3">
        ...
        <nav className="mt-2 flex gap-x-[18px] gap-y-1 overflow-x-auto text-sm tracking-tight whitespace-nowrap text-foreground/70">
